...
const AboutText = () => {
  return (
    <div className="py-20  bg-gray-50  px-5 h-screen flex justify-center xl:h-full sm:px-2 sm:hidden">
      <div className="w-[98%] flex flex-col mx-auto  justify-center text-[4rem] font-serif font-semibold 2xl:w-full 2xl:text-[3.3rem] xl:text-4xl xl:justify-start lg:text-3xl  sm:text-[1rem]  ">
        <span className="font-bold font-serif  text-zinc-700 self-end xl:self-start">
